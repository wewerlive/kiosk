  ...
  return (
    <div className='flex flex-col items-center justify-center w-full h-full'>
      <div className='py-4 px-4 mx-auto max-w-screen-xl text-center lg:py-10 lg:px-12'>
        <h2 className='mb-8 text-5xl font-semibold tracking-widest uppercase text-gray-500 dark:text-gray-400'>
          Twinverse
        </h2>
    ...
    <div className='flex-1 w-fit'>
      {emojis.map((e, i) => (
        <button
          key={i}
          type='button'
          className={`mb-2 m-4 inline-block rounded-full p-2 text-xl font-medium uppercase leading-normal text-whitebg-gray-100 dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 drop-shadow-2xl shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg`}
        >
          {e}
        </button>
      ))}
